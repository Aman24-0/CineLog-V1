...
export const MovieCard = (props) => (
  <div onClick={props.onClick} class="movie-card animate-fade-up">
    <div class="movie-card-inner">
      ...
      {/* Bottom info — z-index: 3 taaki ::after ke upar rahe */}
      <div class="absolute bottom-0 left-0 w-full p-3" style="z-index: 3">
        ...
        {/* Meta */}
        <p style="font-size: 8px; font-weight: 600; color: #d0d0d0; margin-bottom: 6px; letter-spacing: 0.08em; text-transform: uppercase; text-shadow: 0 1px 6px rgba(0,0,0,1)">
