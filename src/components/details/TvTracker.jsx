...
export function TvTracker(props) {
  // ✅ New Feature: isPreviewMode prop — Watch buttons hide, episodes list dikhao
  ...
  return (
    <>
      <div class="glass-surface rounded-[1.75rem] border border-white/10 mb-6 overflow-hidden shadow-2xl" style="background: linear-gradient(145deg, rgba(14,16,24,0.95), rgba(5,6,10,0.92)); border-color: var(--border-active)">
        <div class="p-5 border-b border-white/5">
          <div class="flex items-center justify-between gap-3 mb-4">
            <div>
              <p class="text-[10px] font-black uppercase tracking-[0.22em] flex items-center gap-2" style="color: var(--p)">
                <Icon name="live_tv" class="text-[15px]"/>
                <Show when={previewMode()} fallback="Seasons & Episodes">
                  Season Preview
                </Show>
              </p>
            ...
            <Show when={props.selectedSeasonEpisodes?.length > 0} fallback={
              ...
              <For each={props.selectedSeasonEpisodes}>
                {(ep) => {
                  ...
                  // Preview mode mein sab unwatched dikhao
                      ...
                      <div class="flex gap-3 p-3">
                        ...
                        <div class="min-w-0 flex-1">
                          <div class="flex items-start justify-between gap-3">
                            ...
                            {/* ✅ New Feature: Preview mode mein Watch button nahi dikhega */}
      ...
      {/* Tracker bar — sirf non-preview mode mein */}
      <Show when={!previewMode()}>
        <div class="glass-surface p-5 rounded-2xl border border-white/5 mb-6">
          ...
          <div class="w-full h-2 bg-black rounded-full overflow-hidden mb-4">
            <div class="h-full bg-[var(--primary)] transition-all shadow-[0_0_10px_var(--primary)]" style={{width:`${props.progressPct}%`}}></div>
          </div>
