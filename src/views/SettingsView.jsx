  ...
  >
    <div
      ...
      style={{
        ...
        boxShadow: props.unlocked ? '0 0 16px var(--p-glow)' : 'none',
          ...
          <div class="glass-surface rounded-2xl p-5 border border-white/5">
            ...
            <Show when={favoriteGenre()} fallback={
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  <Icon name="genre" fill class="text-xl" style="color: var(--p)" />
                </div>
                <div class="min-w-0">
          ...
          <div class="glass-surface rounded-2xl p-5 border border-white/5">
            ...
            <Show when={favoriteActor()} fallback={
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  <Icon name="person" fill class="text-xl" style="color: var(--p2)" />
                </div>
                <div class="min-w-0">
